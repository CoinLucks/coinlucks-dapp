...
export const bscTokens = {
  ...
  bscdefi: new ERC20Token(
    ...
    18,
    'BSCDEFI',
    'ChainId.BNB Defi blue chips token',
    'https://powerpool.finance/',
  ),
  busd: BUSD_BSC,
  dai: new ERC20Token(
  ...
  qi: new ERC20Token(ChainId.BNB, '0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5', 18, 'QI', 'BENQI', 'https://benqi.fi/'),
  ...
  co: new ERC20Token(ChainId.BNB, '0x936B6659Ad0C1b244Ba8Efe639092acae30dc8d6', 6, 'CO', 'CO', 'https://corite.com/'),
  krs: new ERC20Token(
    ChainId.BNB,
  ...
  ordi: new ERC20Token(ChainId.BNB, '0xe2aE1a99bBd2eFab0a5C38f2146B7aCE61aBC5cE', 18, 'ordi', 'ordi', ''),
  mubi: new ERC20Token(
    ChainId.BNB,
  ...
  defi: new ERC20Token(ChainId.BNB, '0x6d106C0B8d2f47c5465bdBD58D1Be253762cBBC1', 18, 'DEFI', 'DeFi', 'https://de.fi/'),
  xrgb: new ERC20Token(
    ChainId.BNB,
