...
const BetButtonPlay = ({
  ...
  const { reset: resetBet, queryBet } = useBetGameResultContext();
  ...
  const { setStatus } = useScratcherContext();
  ...
  const handlePayment = (e: any) => {
    ...
    // reset scratch card
    resetBet();
    setStatus(ScratchStatus.DEFAULT);
    ...
    writeContract({
      ...
      args: [parseEther(amount), zeroAddress, account?.referrer ?? zeroAddress, ""],
